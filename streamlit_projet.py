...
# On ne garde dans le dictionnaire que les colonnes qui existent vraiment dans le df
colonnes_existantes={k: v for k,v in dictionnaires.items() if k in df.columns}
# On transforme seulement ces colonnes 
df_new=df.astype(colonnes_existantes)
